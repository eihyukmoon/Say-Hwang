...
export default function MainPage2({ audioSrc, text, timingData, isLoading, onBack, onLogout, onMyPage }: MainPage2Props) {
    ...
    return (
        <div className="w-full relative overflow-hidden">
            ...
            {/* Header */}
            <header className="absolute top-0 left-0 w-full p-8 flex items-center justify-between z-20 pointer-events-none">
                <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-zinc-500 pointer-events-auto">
                    Say Hwang
                </h1>
