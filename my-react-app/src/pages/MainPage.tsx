...
export default function MainPage({ onLogout, onMyPage, onGenerateStart, onCake }: MainPageProps) {
    ...
    return (
        <div className="w-full bg-zinc-950 text-zinc-100 relative">
            ...
            {/* Left 3/4 Position Large Button */}
            <div className="fixed left-3/4 top-1/2 -translate-y-1/2 z-20 pointer-events-auto">
                <button
                    onClick={onCake}
                    className="w-48 h-48 rounded-full hover:scale-110 transition-all hover:shadow-2xl"
                    title="케이크"
                >
                    <img 
                        src="/케케이크.jpg" 
